...
<main>
    ...
    <section>
        ...
        <div class="pages">
            ...
            <div class="page-card"><strong>query-book.php · QueryBook</strong><span>Ask the finished book questions in ten answer modes (Q&amp;A, conversational, research, executive brief, tutorial, study, quotes, expository, argumentative, descriptive) — tailored to your industry — and request any deliverable: summaries, analysis, synopses, abstracts, outlines, glossaries, FAQs, study guides, key quotes, reading plans, and comparisons, downloadable as Markdown, text, or JSON.</span></div>
