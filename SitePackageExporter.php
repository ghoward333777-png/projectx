...
final class SitePackageExporter
{
    ...
    private const FILES = [
        ...
        'download-app.php',
        'data/teen-jobs.json',
        'dating/SlowDatingStore.php',
        'dating/SlowDatingEngine.php',
        ...
        'dating/bin/check-demo-streams.php',
        ...
        'dating/ui.php',
        'dating/assets/tour/01-home.jpg',
        'dating/assets/tour/02-matches.jpg',
        'dating/assets/tour/03-slow-chat.jpg',
        'dating/assets/tour/04-search.jpg',
        'dating/assets/tour/05-profile.jpg',
        'dating/assets/tour/06-wallet.jpg',
        'dating/assets/tour/07-store.jpg',
        'dating/assets/tour/08-membership.jpg',
        'dating/assets/tour/09-partner.jpg',
        ...
        'dating/GUIDE.md',
        'dating/openapi.yaml',
        'dating/video-chat-player/API.md',
        'dating/video-chat-player/EMBED.md',
        'dating/video-chat-player/INTEGRATIONS.md',
        'dating/video-chat-player/README.md',
        'dating/video-chat-player/api-docs.php',
        'dating/video-chat-player/api.php',
        'dating/video-chat-player/assets/api.js',
        'dating/video-chat-player/assets/app.js',
        'dating/video-chat-player/assets/bridge.js',
        'dating/video-chat-player/assets/bus.js',
        'dating/video-chat-player/assets/chat.js',
        'dating/video-chat-player/assets/controls.js',
        'dating/video-chat-player/assets/docs.css',
        'dating/video-chat-player/assets/embed-demo.js',
        'dating/video-chat-player/assets/embed.js',
        'dating/video-chat-player/assets/health.js',
        'dating/video-chat-player/assets/idle.js',
        'dating/video-chat-player/assets/overlay.js',
        'dating/video-chat-player/assets/player/adapter.js',
        'dating/video-chat-player/assets/player/html5.js',
        'dating/video-chat-player/assets/player/proxy.js',
        'dating/video-chat-player/assets/player/youtube-lite.js',
        'dating/video-chat-player/assets/player/youtube.js',
        'dating/video-chat-player/assets/playlist.js',
        'dating/video-chat-player/assets/sdk.js',
        'dating/video-chat-player/assets/stage.js',
        'dating/video-chat-player/assets/state-machine.js',
        'dating/video-chat-player/assets/styles.css',
        'dating/video-chat-player/assets/sync.js',
        'dating/video-chat-player/config.php',
        'dating/video-chat-player/embed-demo.php',
        'dating/video-chat-player/embed.php',
        'dating/video-chat-player/index.php',
        'dating/video-chat-player/lib/Embed.php',
        'dating/video-chat-player/lib/Http.php',
        'dating/video-chat-player/lib/IntegrationBuilder.php',
        'dating/video-chat-player/lib/MessageLog.php',
        'dating/video-chat-player/lib/OpenApi.php',
        'dating/video-chat-player/lib/PlaybackState.php',
        'dating/video-chat-player/lib/Playlist.php',
        'dating/video-chat-player/lib/RestApi.php',
        'dating/video-chat-player/lib/RoomStore.php',
        'dating/video-chat-player/lib/Source.php',
        'dating/video-chat-player/lib/Text.php',
        'dating/video-chat-player/lib/WatchRoomApi.php',
        'dating/video-chat-player/lib/Webhooks.php',
        'dating/video-chat-player/media.php',
        'dating/video-chat-player/media/sample.mp4',
        ...
        'tests/dating-engine-contract.php',
